...
const LINK_MAP = [
  ...
  // 保險類
  { keyword: "醫療險", url: "/articles/health-insurance-before-retirement", selfSlug: "health-insurance-before-retirement" },
  { keyword: "長照險", url: "/articles/long-term-care-insurance-gap", selfSlug: "long-term-care-insurance-gap" },
  { keyword: "儲蓄險", url: "/articles/savings-insurance-vs-investing", selfSlug: "savings-insurance-vs-investing" },
  { keyword: "意外險", url: "/articles/accident-insurance-retirement-planning", selfSlug: "accident-insurance-retirement-planning" },
  // 稅務類
  { keyword: "海外所得", url: "/articles/overseas-income-tax-us-etf", selfSlug: "overseas-income-tax-us-etf" },
  { keyword: "股利所得", url: "/articles/etf-dividend-tax-taiwan", selfSlug: "etf-dividend-tax-taiwan" },
  { keyword: "遺產稅", url: "/articles/inheritance-tax-retirement-planning", selfSlug: "inheritance-tax-retirement-planning" },
  // 人生階段類
  { keyword: "社會新鮮人", url: "/articles/first-job-retirement-planning", selfSlug: "first-job-retirement-planning" },
  { keyword: "頂客族", url: "/articles/dink-retirement-planning", selfSlug: "dink-retirement-planning" },
  { keyword: "單身族", url: "/articles/single-retirement-planning", selfSlug: "single-retirement-planning" },
  { keyword: "二次就業", url: "/articles/post-retirement-second-career", selfSlug: "post-retirement-second-career" },
];
