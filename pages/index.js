  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="退休咖提供免費 AI 退休金試算工具，五分鐘算出你的退休缺口、資產配置建議。含勞保勞退試算、FIRE 財務自由計算，及原創理財知識文章。" />
        <link rel="canonical" href="https://retirementplantw.com" />
        <meta property="og:title" content="退休咖 | 免費退休金與資產配置試算" />
      ...
      <nav className="nav">
        <div className="nav-logo">退休咖</div>
