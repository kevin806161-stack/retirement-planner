  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://retirementplantw.com/tools/labor-insurance" />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              name: "勞保年金試算器",
              description: "計算勞保老年年金月領金額與延後請領加成",
              url: "https://retirementplantw.com/tools/labor-insurance",
