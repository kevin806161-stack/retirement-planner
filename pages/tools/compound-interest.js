  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://retirementplantw.com/tools/compound-interest" />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              name: "複利成長試算器",
              description: "視覺化投資組合的長期複利成長曲線",
              url: "https://retirementplantw.com/tools/compound-interest",
