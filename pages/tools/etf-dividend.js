  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .etf-btn.active { border-color: #c9a24b; background: rgba(201,162,75,0.14); }
        ...
        .etf-freq { font-size: 12px; color: #c9a24b; background: rgba(201,162,75,0.14); padding: 2px 10px; border-radius: 12px; }
