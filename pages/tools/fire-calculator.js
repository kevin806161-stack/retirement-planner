  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://retirementplantw.com/tools/fire-calculator" />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              name: "FIRE 財務自由試算器",
              description: "計算 FIRE 財務自由所需資產與達成時間",
              url: "https://retirementplantw.com/tools/fire-calculator",
