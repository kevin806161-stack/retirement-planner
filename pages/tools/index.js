...
export default function ToolsIndex() {
  return (
    <>
      ...
      <style jsx>{`
        .tools-page { max-width: 760px; margin: 0 auto; padding: 56px 24px 80px; }
        .tools-hero { text-align: center; margin-bottom: 40px; }
        .tools-hero h1 { font-family: "Noto Sans TC", sans-serif; font-size: 30px; font-weight: 900; color: #0f2130; margin-bottom: 10px; }
        .tools-hero p { font-family: "Noto Serif TC", serif; font-size: 15px; color: #6a7480; }
        .tools-grid { display: flex; flex-direction: column; gap: 14px; }
        .tool-card {
          display: flex; align-items: center; gap: 16px;
          border: 1px solid rgba(15,33,48,0.14); border-radius: 6px;
          padding: 18px 20px; text-decoration: none; color: inherit;
          background: #fbf8f1; transition: border-color 0.2s, box-shadow 0.2s;
        }
        .tool-card:hover { border-color: #c9a24b; box-shadow: 0 2px 14px rgba(15,33,48,0.08); }
        .tool-icon {
          width: 52px; height: 52px; border-radius: 4px; display: flex;
          align-items: center; justify-content: center;
          font-family: "Noto Serif TC", serif; font-size: 22px; font-weight: 700;
          color: #c9a24b; background: #0f2130; flex-shrink: 0;
        }
        .tool-content { flex: 1; }
        .tool-header { display: flex; align-items: center; gap: 8px; margin-bottom: 4px; }
        .tool-content h2 { font-family: "Noto Sans TC", sans-serif; font-size: 16px; font-weight: 700; color: #0f2130; }
        .tool-badge { font-size: 10px; background: #c9a24b; color: #0f2130; font-weight: 700; padding: 2px 8px; border-radius: 3px; }
        .tool-content p { font-family: "Noto Serif TC", serif; font-size: 13px; color: #6a7480; line-height: 1.5; }
        .tool-arrow { font-size: 18px; color: #c9a24b; flex-shrink: 0; }
      `}</style>
    </>
  );
}
