  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://retirementplantw.com/tools" />
        <meta property="og:title" content="AI 理財計算工具 | 退休咖" />
        <meta property="og:description" content="免費 AI 理財計算工具：退休試算、勞保年金、FIRE 試算、複利計算、ETF 配息試算。" />
        <meta property="og:url" content="https://retirementplantw.com/tools" />
