...
export default function ArticlePage({ article, allArticles }) {
  ...
  const linkedContent = autoLinkContent(article.content, article.slug);
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`https://www.retirementplantw.com/articles/${article.slug}`} />
        <meta property="og:site_name" content="退休咖" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content={`${article.title} | 退休咖`} />
        <meta property="og:description" content={article.description} />
        <meta property="og:url" content={`https://www.retirementplantw.com/articles/${article.slug}`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntityOfPage: `https://www.retirementplantw.com/articles/${article.slug}`,
            }),
          }}
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "BreadcrumbList",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "首頁", item: "https://www.retirementplantw.com" },
                { "@type": "ListItem", position: 2, name: "理財知識", item: "https://www.retirementplantw.com/articles" },
                { "@type": "ListItem", position: 3, name: article.title, item: `https://www.retirementplantw.com/articles/${article.slug}` },
              ],
            }),
          }}
        />
      ...
      <style jsx>{`
        ...
        .article-body :global(a) { color: #1d6fd8; text-decoration: underline; text-underline-offset: 2px; }
