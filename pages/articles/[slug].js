    ...
    <>
      ...
      <style jsx>{`
        ...
        .article-category {
          ...
          font-size: 11px; color: #7a5a1f; background: rgba(201,162,75,0.14);
          display: inline-block; padding: 3px 10px; border-radius: 3px; margin-bottom: 14px;
        }
        h1 { font-family: "Noto Sans TC", sans-serif; font-size: 30px; font-weight: 900; color: #0f2130; line-height: 1.4; margin-bottom: 10px; }
        .article-meta { font-size: 13px; color: #8a929b; margin-bottom: 32px; }
        .article-body :global(h1) { font-family: "Noto Sans TC", sans-serif; font-size: 24px; font-weight: 700; color: #0f2130; margin: 32px 0 16px; }
        .article-body :global(h2) { font-family: "Noto Sans TC", sans-serif; font-size: 20px; font-weight: 700; color: #0f2130; margin: 28px 0 14px; }
        .article-body :global(p) { font-family: "Noto Serif TC", serif; font-size: 15.5px; line-height: 1.95; color: #3d4954; margin-bottom: 16px; }
        .article-body :global(ul), .article-body :global(ol) { padding-left: 22px; margin-bottom: 16px; }
        .article-body :global(li) { font-family: "Noto Serif TC", serif; font-size: 15.5px; line-height: 1.85; color: #3d4954; margin-bottom: 8px; }
        .article-body :global(pre) {
          background: #ece4d5; border: 1px solid rgba(15,33,48,0.14); border-radius: 4px;
        ...
        .article-body :global(th) { background: #ece4d5; padding: 10px 12px; text-align: left; border: 1px solid rgba(15,33,48,0.14); font-weight: 700; color: #0f2130; }
        ...
        .article-body :global(strong) { font-weight: 700; color: #0f2130; }
        .article-body :global(a) { color: #c9a24b; }
